        ...
        <input
          {...register("username", {
            ...
            pattern: {
              ...
              message:
                "The login must start with a letter and contain only Latin characters",
            },
          })}
        />
      </label>
        ...
        <input
          ...
          {...register("password", {
            ...
            pattern: {
              ...
              message:
                "The password must contain at least 6 characters, at least one capital letter, one digit and one special character.",
            },
          })}
        />
      </label>
